...
\begin{enumerate}
  ...
  The derivation chain from the assumed $1/\ln$ spectral density to the $1/\ln^2$ cooling law involves three conjectural steps (Assumptions 1--3 in \cref{sec:dsc}).
  ...
  The held-out test (Supplementary Material) shows that the 3D reconstruction from a single hemisphere does not predict the unseen hemisphere ($r_{\mathrm{test}} = -0.17$).
