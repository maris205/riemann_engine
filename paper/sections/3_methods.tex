...
\subsection{Two-dimensional symplectic lattice}
\label{sec:2d}
...
\paragraph{Mock $\Lambda$CDM reference.}
For 2D power spectrum comparisons, we use
\begin{equation}
  D(k)_{\Lambda\mathrm{CDM}} = e^{-(k/35)^2}\!\left[1 + 1.2\sin^2\!\left(\frac{\pi k}{12}\right)\right]\frac{50}{k + 10}\,,
  \label{eq:mock}
\end{equation}
